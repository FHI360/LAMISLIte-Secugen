...
public class IndexTesting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (hts != null) {
            ...
            auoIncrementClientCode = hts.getLgaId() + "/" + hts.getFacilityId() + "/" + settingConfig.getTodaysyear() + "/" + settingConfig.getTodaysmonth() + "/" + sum + "/" + hts.getDeviceconfigId();
...
//
        ...
        finishButton2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (indexType.getSelectedItem().toString().equals("")) {
                    ...
                    indexContact.setClientCode(Objects.requireNonNull(hts).getClientCode());
    ...
    private void showAlert() {
        ...
        notitopNotnow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(IndexTesting.this, Home.class);
